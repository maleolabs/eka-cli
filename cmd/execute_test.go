...
func TestVersionCommand(t *testing.T) {
	...
	if !strings.Contains(out, "eka dev") || !strings.Contains(out, "EKA standard 1.0.0") {
...
func TestExitCodeUsage(t *testing.T) {
	...
	if !strings.Contains(errText, "available commands: context, discard, draft, edit, export, feedback, get, import, init, install, integrity, new, note, project, publish, snapshot, status, sync, transition, update, validate, version, view, watch") {
...
func TestValidateValidRepoExitsZero(t *testing.T) {
	...
	if !strings.Contains(text, "Knowledge   EKA v1.0.0") {
