...
func TestExitCodeUsage(t *testing.T) {
	...
	if !strings.Contains(errText, "available commands: assign, capture, code-context, code-discover, code-get, context, discard, draft, edit, export, feedback, get, import, init, integrity, mcp, new, note, plugin, project, publish, reassign, relate, shr, snapshot, status, sync, transition, unassign, update, validate, version, view, watch") {
